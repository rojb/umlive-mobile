...
///
/// **The write path does not exist here.** Slot filling, read-back and the
/// destructive guard are `T13`; until they land, an utterance that asks for a
/// write is reported as not understood, which is the truth about this build.
library;
...
class DeterministicOperationResolver implements OperationResolver {
  ...
  /// The two values the `[umlive][resolver]` line's `result` field takes.
  ///
  ...
  /// says which. `not_understood` means nothing was resolved and no call was
  /// made.
